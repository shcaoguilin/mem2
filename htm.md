...
| cell(c,i) | zzzz | 
| cellsPerColumn | zzzz | 
| activeColumns(t) | zzzz | 
| activeState(c,i,t) | zzzz | 
| predictiveState(c,i,t) | zzzz | 
| learnState(c,i,t) | zzzz | 
| activationThreshold | zzzz | 
| learningRadius | zzzz | 
| initialPerm | zzzz | 
| connectedPerm | zzzz | 
| minThreshold | zzzz | 
| newSynapseCount | zzzz | 
| permanenceInc | zzzz | 
| permanenceDec | zzzz | 
| segmentUpdate | zzzz | 
| segmentUpdateList | zzzz | 

- 下面的支持例程被用在以上代码中：

| 名字 | 解释 |
| :----------:| :----- |
| segmentActive(s,t,state) | zzzz | 
| getActiveSegment(c,i,t,state) | zzzz | 
| getBestMatchingSegment(c,i,t) | zzzz | 
| getBestMatchingCell(c) | zzzz | 
| getSegmentActiveSynapses(c,i,t,s,newSynapses=false) | zzzz | 
| adapatSegments(segmentList,positiveReinforcement) | zzzz | 
